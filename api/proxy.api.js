...
import { ERROR_MESSAGES, CONSOLE_MESSAGES } from '../conf/constants.conf.js';
...
export const { handleAsyncBackgroundMessage, sendMessageToBackgroundScript } = ChromeProxy || {};

export default new ChromeProxy();
