...
import { AUTH_TYPES, HTTP_HEADERS, CONSOLE_MESSAGES, ERROR_MESSAGES, DEFAULT_VALUES } from '../conf/constants.conf.js';
...
export const { makeAuthenticatedApiRequest, buildCleanApiUrl } = Request || {};
